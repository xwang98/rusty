...
use crate::{
    ...
    index::{DeclarationType, VariableIndexEntry, VariableType},
...
fn compare_function_exists(
    ...
    if let Some(implementation) = implementation {
        ...
        if let [VariableIndexEntry {
            ...
            variable_type: DeclarationType::ByVal(VariableType::Input),
            ..
        }, VariableIndexEntry {
            ...
            variable_type: DeclarationType::ByVal(VariableType::Return),
            ..
        }] = members.as_slice()
        {
